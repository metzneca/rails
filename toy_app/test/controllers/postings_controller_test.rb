...
class PostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post postings_url, params: { posting: { content: @posting.content, user_id: @posting.user_id } }
    end
  ...
  test "should update posting" do
    patch posting_url(@posting), params: { posting: { content: @posting.content, user_id: @posting.user_id } }
